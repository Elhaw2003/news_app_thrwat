...
class HomeRepoImplementationApi implements HomeRepo{
  List<ItemModelForNews> news = [];
  final dio = Dio();
  @override
  Future<Either<Failure, List<ItemModelForNews>>> getTopHeadLineFunc() async{
    try{
      var response = await dio.get("${EndPoints.baseUrl}${EndPoints.topHeadLineEndPoint}?category=technology&apiKey=${EndPoints.apiKey}");
